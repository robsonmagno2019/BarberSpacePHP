...
<section class="content">
  <form action="/durationcontracts/{{ $durationContract->id }}" method="POST" role="form">
    @csrf
    <!-- Default box -->
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Editar Duração de Contrato</h3>
      ...
      <div class="box-body">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="description" name="description" placeholder="Digite aqui a duração de contrato."
            value="{{ $durationContract->description }}">
