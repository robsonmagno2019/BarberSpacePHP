...
<section class="content">
  <form action="/tiposderemuneracoes/{{ $typeOfRemuneration->id }}" method="POST" role="form">
    @csrf
    <!-- Default box -->
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Editar Tipo de Remuneração</h3>
      ...
      <div class="box-body">
        <div class="box-body">
          <div class="form-group">
            ...
            value="{{ $typeOfRemuneration->description }}">
